...
superpopXcolours <- c(rep("#009E73",15), rep("#CC79A7",4), rep("#56B4E9",5), rep("#E69F00",5), rep("#000000",5))
...
polymorphicTable <- read.table("${poly_count}", header=F, sep=';')
rownames(polymorphicTable) <- polymorphicTable[,1]
polymorphicTable <- polymorphicTable[,-1]
...
polymorphicTable\$Populations <- rownames(polymorphicTable)
